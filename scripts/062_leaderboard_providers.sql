...
CREATE TABLE IF NOT EXISTS leaderboard_providers (
  ...
  -- score_divisor is added by 063, not here: this file had already been run
  -- when the coin conversion was discovered, and a migration that has been
  -- applied does not get edited afterwards.
